"""
Notes:
    Based on template code in: ~/code/ustd/docs/source/conf.py
    ...
    cd ~/code/ustd/docs
    sphinx-apidoc -f -o ~/code/ustd/docs/source ~/code/ustd/ustd --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/ustd/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/ustd/versions/
"""
#
...
# html_logo = '.static/ustd.svg'
# html_favicon = '.static/ustd.ico'
...
latex_documents = [
    (master_doc, 'ustd.tex', 'ustd Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'ustd', 'ustd Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ustd', 'ustd Documentation',
     author, 'ustd', 'One line description of project.',
     'Miscellaneous'),
]
